...
Phase 1 author/source intelligence, alerts, saved reports, and public briefs are still derived from `feed_cards` plus related payloads. Phase 2 source records, source feeds, and ingested articles are now first-class. Node and comparison tables are present for the next implementation steps.
